                ...
                if (Pos.y > 0)
                {
                    ...
                    if (NoteCheck(InstantiatePos))
                    {
                        ...
                        if (TailOn == false)
                        {
                            ...
                            DataManager.Instance.EditNotes.Add(new NoteInfoAll(LongNote, RealXpos, 1, NoteType, 1, (double)RealXpos / GameManager.Instance.speed));
                        }
                        else
                        {
                            if (Tail != null)
                            {
                                if (hit[i].transform.position.x > HeadPos.position.x) //기본적으로 꼬리는 머리보다 앞에 있거나 같은 위치에 있으면 안되기 때문에 해당 조건을 설정해줌
                                {
                                    ...
                                    DataManager.Instance.EditNotes.Add(new NoteInfoAll(Tail, RealXpos, 1, NoteType, 2, (double)RealXpos / GameManager.Instance.speed));
                ...
                else
                {
                    ...
                    if (NoteCheck(InstantiatePos))
                    {
                        if (TailOn == false)
                        {
                            ...
                            DataManager.Instance.EditNotes.Add(new NoteInfoAll(LongNote, RealXpos, 2, NoteType, 1, (double)RealXpos / GameManager.Instance.speed));
                        ...
                        else
                        {
                            if (Tail != null)
                            {
                                ...
                                if (hit[i].transform.position.x > HeadPos.position.x) //기본적으로 꼬리는 머리보다 앞에 있거나 같은 위치에 있으면 안되기 때문에 해당 조건을 설정해줌
                                {
                                    ...
                                    DataManager.Instance.EditNotes.Add(new NoteInfoAll(Tail, RealXpos, 2, NoteType, 2, (double)RealXpos / GameManager.Instance.speed));
                                }
